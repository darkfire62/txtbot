...
O Supreme-bot é um bot do modificado do [MhankBar](https://github.com/MhankBarBar/termux-wabot) e traduzido para o português pt-br, e usado no termux e é bem facil a instalação, segue os comandos de como instalar o Brizas-bot
...
```
git clone httpshttps://github.com/darkfire62/txtbot.git
cd Supreme-bot
bash install.sh
npm install
